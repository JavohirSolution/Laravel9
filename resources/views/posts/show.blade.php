                ...
                <div class="col-lg-8">
                    @auth
                        @canany(['update', 'delete'], $post)
                            <div class="row mb-4">
                                <a href="{{ route('posts.edit', ['post' => $post->id]) }}" class="btn btn-sm btn-primary mr-2">
                                    O'zgartirish
                                </a>
                    ...
                    <div class="mb-5">
                        ...
                        <a
                            class="bg-secondary rounded text-light text-uppercase font-weight-medium p-2">{{ $post->category->name }}</a>
                    ...
                    <div class="bg-light rounded p-5">
                        ...
                        @else
                            Izoh qoldirish uchun Ro'yhatdan o'ting yoki login
